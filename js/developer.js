      ...
      <div class="text-center mb-24 dev-card">
        ...
        <div class="relative inline-block mb-10" style="animation: devFloat 4s ease-in-out infinite;">
          ...
          <div class="relative w-36 h-36 lg:w-44 lg:h-44 rounded-[2.5rem] overflow-hidden border-2 border-white/20 shadow-[0_20px_50px_-10px_rgba(200,162,74,0.4)] rotate-3 hover:rotate-0 transition-transform duration-500 bg-[#060b18]">
            <img src="assets/img/abhi.jpeg" alt="Abhishek Kumar" class="absolute inset-0 w-full h-full object-cover z-10">
            <!-- Glass Overlay -->
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center relative z-10">
              ...
              <div>
                ...
                <div class="flex items-center gap-4 mb-2">
                  <h4 class="text-4xl font-black text-white">ANVI STAY</h4>
                  <a href="https://anvi-stay.vercel.app/" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center w-10 h-10 rounded-xl bg-white/5 border border-white/10 hover:bg-[#C8A24A]/20 hover:border-[#C8A24A]/50 hover:text-[#C8A24A] transition-all text-slate-400 group relative">
                ...
                <a href="https://anvi-stay.vercel.app/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-gradient-to-r from-[#C8A24A] to-amber-700 text-white font-bold text-sm transition-all duration-300 hover:scale-105 hover:shadow-[0_10px_30px_-10px_rgba(200,162,74,0.6)] group">
                  <i class="fas fa-globe"></i> Live Preview <i class="fas fa-arrow-right group-hover:translate-x-1 transition-transform ml-1"></i>
                </a>
              </div>
          ...
          <div class="relative bg-[#0b1120] rounded-[2.25rem] p-8 lg:p-12 overflow-hidden">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center relative z-10">
              ...
              <div>
                ...
                <div class="flex items-center gap-4 mb-2">
                  <h4 class="text-4xl font-black text-white">Heaven Rooms</h4>
                  <a href="https://heaven-rooms.vercel.app/" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center w-10 h-10 rounded-xl bg-white/5 border border-white/10 hover:bg-emerald-500/20 hover:border-emerald-500/50 hover:text-emerald-400 transition-all text-slate-400 group relative">
                    <i class="fas fa-external-link-alt group-hover:scale-110 transition-transform"></i>
                  </a>
                </div>
                ...
                <a href="https://heaven-rooms.vercel.app/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-700 text-white font-bold text-sm transition-all duration-300 hover:scale-105 hover:shadow-[0_10px_30px_-10px_rgba(16,185,129,0.5)] group">
                  <i class="fas fa-globe"></i> Live Preview <i class="fas fa-arrow-right group-hover:translate-x-1 transition-transform ml-1"></i>
                </a>
              </div>
      ...
      <div class="text-center dev-card pb-12">
        <div class="bg-gradient-to-b from-[#0f172a] to-[#060b18] rounded-[3rem] p-12 lg:p-16 border border-white/[0.08] border-t-[#C8A24A]/30 relative overflow-hidden shadow-2xl">
          ...
          <div class="relative z-10 max-w-2xl mx-auto">
            ...
            <p class="text-slate-400 text-base lg:text-lg mb-10">Whether you need a complex web application, a premium landing page, or a complete digital transformation, I'm here to bring your vision to reality.</p>
